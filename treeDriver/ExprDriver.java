...
public class ExprDriver 
{
  ...
  {   System.out.println ("\n\nTesting problem 2");
      ...
      System.out.println("\nQUIZ TESTING!!");
      e1 = new Difference (new Constant(3), new Constant(5));       //  3 - 5
      e2 = new Difference (new Constant(5), new Constant (3));
      e1 = new Quotient (e1, e2);
      System.out.println ("The quotient is " + e1);  
      System.out.println ("It simplifies to " + e1.simplify());  
      System.out.println(e1.eval());
      e1 = new Difference (new Constant(12), new Constant(2));       //  3 - 5
      e2 = new Difference (new Constant(2), new Constant (12));
      e1 = new Quotient (e1, e2);
      System.out.println ("The quotient is " + e1);  
      System.out.println ("It simplifies to " + e1.simplify());  
      System.out.println(e1.eval());
